...
\includegraphics[width=\textwidth]{avg_time.png}
\caption{}
\label{fig:avg_time}
\end{subfigure}
\begin{subfigure}{0.49\textwidth}
\includegraphics[width=\textwidth]{eigen.png}
\caption{}
\label{fig:eigen}
\end{subfigure}
\begin{subfigure}{0.49\textwidth}
\includegraphics[width=\textwidth]{dis_var.png}
\caption{}
\label{fig:dis_var}
\end{subfigure}
\begin{subfigure}{0.49\textwidth}
\includegraphics[width=\textwidth]{avg_goal.png}
\caption{}
\label{fig:avg_goal}
\end{subfigure}
